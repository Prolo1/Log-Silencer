	...
	public partial class LogSilencer_Core : BaseUnityPlugin
	{
		...
		void Awake()
		{
			...
			cfg = new LogSilencerConfig
			{
				...
				disableMessageLogs = Config.Bind("_Main_", "Disable Message Logs", false, new ConfigDescription("Disables message logs from being written to the log file (enabling this can help improve performance)", null, new ConfigurationManagerAttributes { Order = --index })),
